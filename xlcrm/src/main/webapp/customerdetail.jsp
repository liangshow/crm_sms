							...
							<div role="tabpanel" class="tab-pane active" id="aa">
								...
								<div class="info">
									<div class="col-md-8">
										<table class="table ">
											<tr>
												<td>姓名：${customer.cus_name}</td>
												<td>公司：亮晶晶速递</td>
											</tr>
											<tr>
												<td>生日：${customer.cus_birthday}</td>
												<td>行业：${customer.cus_industry}</td>
											</tr>
											<tr>
												<td>性别：
													<c:if test="${customer.cus_sex=='2'}">男</c:if>
													<c:if test="${customer.cus_sex=='1'}">女</c:if>
												</td>
												<td>客户等级：${customer.cus_level}</td>
											</tr>
											<tr>
												<td>座机：</td>
												<td>手机：${customer.telnum}</td>
											</tr>
											<tr>
												<td>Email:</td>
												<td>地址：${customer.cus_address}</td>
											</tr>
									...
									<div class="col-md-4">
										...
										<div class="text-center">
											<img src="${pageContext.request.contextPath}/img/show/photo.png" class="img-responsive" align="我的头像" />
											</p>
										</div>
			...
			$.ajax({
				...
				success:function(data) {
					...
					$.each(json, function(index,item) {
						...
						+item.name+"</td><td>"
						+item.price+"</td><td>"
						+item.number+"</td><td><a href='#' class='btn btn-primary btn-xs' data-toggle='modal'>查看</a></td></tr>");
						onclick=" (${row.id})"
					});
				}
			});
